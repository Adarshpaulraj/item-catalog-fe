...
function Women() {
 ...
 const itemProducts=products.filter((e)=>e.category.toLowerCase()==='women')
   return  <div className='container-fluid card-img'  onClick={()=>navigate(`/item/${e._id}`)}>
    {
      itemProducts.map((e)=>{
       return <Card className='boxhover'  style={{ width: '13rem'  }}>
